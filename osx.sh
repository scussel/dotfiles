...
open "${HOME}/prefs/iterm/Solarized Dark.itermcolors"
...
cp -r prefs/subliem/Preferences.sublime-settings ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Preferences.sublime-settings 2> /dev/null
cp -r prefs/subliem/Material-Theme.sublime-theme ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Material-Theme.sublime-theme 2> /dev/null
cp -r prefs/subliem/Material-Theme-Darker.sublime-theme ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Material-Theme-Darker.sublime-theme 2> /dev/null
